...
function addPushNotificationTokenForUserId(userId, pushToken) {
  ...
  .catch(err => {
    console.log(err);
    console.log('something went wrong in addPushNotificationTokenForUserId')
  })
};
...
function removeUserId(userId) {
  ...
  .catch(err => {
    console.log('something went wrong in removeUserId')
    console.log(err);
  })
};
...
function closeChat(chatId) {
  ...
  .catch(err => {
    console.log('something went wrong in closeChat')
    console.log(err);
  })
};
...
function markRead(userId, type) {
  ...
  .catch(err => {
    console.log('something went wrong in markRead')
    console.log(err);
  })
};
...
function sendMatchNotification(userId1, userId2) {
  ...
  .catch(err => {
    console.log('something went wrong in sendMatchNotification')
    console.log(err);
  })
};
